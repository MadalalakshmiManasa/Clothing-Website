...
//           <button className="quick-view-btn" aria-label="Quick View">Quick View</button>
//           <button className="add-to-cart-btn" aria-label="Add to Cart" disabled={!inStock}>
...
//         {/* <button className={`compare-btn ${compare ? 'active' : ''}`} onClick={toggleCompare}>
//           {compare ? 'Remove from Compare' : 'Add to Compare'}
//         </button> */}
//       </div>
